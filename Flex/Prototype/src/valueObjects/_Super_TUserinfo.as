 ...
 * of this value object you may modify the generated sub-class of this class - TUserinfo.as.
 */
...
[ExcludeClass]
public class _Super_TUserinfo extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void 
    {
        try 
        {
            if (flash.net.getClassByAlias("cn.edu.whu.lmars.model.TUserinfo") == null)
            {
                flash.net.registerClassAlias("cn.edu.whu.lmars.model.TUserinfo", cz);
            } 
        }
        catch (e:Error) 
        {
	...
	model_internal var _dminternal_model : _TUserinfoEntityMetadata;
	...
	private var _internal_isAdmin : int;
	private var _internal_realname : String;
	private var _internal_departmentCode : int;
	...
	public function _Super_TUserinfo() 
	{	
		_model = new _TUserinfoEntityMetadata(this);
	...
	[Bindable(event="propertyChange")] 
    public function get isAdmin() : int    
    {
    ...
    public function set isAdmin(value:int) : void 
    {    	
        var recalcValid:Boolean = false;
    	
    	
    	var oldValue:int = _internal_isAdmin;               
        if (oldValue !== value)
        {
            _internal_isAdmin = value;
        	this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "isAdmin", oldValue, _internal_isAdmin));
        }    	     
    ...
    {    	
    	...
    	var oldValue:int = _internal_departmentCode;               
        if (oldValue !== value)
        {
   ...
   model_internal function setterListenerAnyConstraint(value:flash.events.Event):void
   {
    ...
    [Transient] 
	[Bindable(event="propertyChange")] 
    public function get _model() : _TUserinfoEntityMetadata
    {
		return model_internal::_dminternal_model;              
    }	
    
    public function set _model(value : _TUserinfoEntityMetadata) : void       
    {
    	var oldValue : _TUserinfoEntityMetadata = model_internal::_dminternal_model;               
        if (oldValue !== value)
        {
