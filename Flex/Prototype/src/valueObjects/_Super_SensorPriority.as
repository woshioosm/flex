 ...
 * of this value object you may modify the generated sub-class of this class - SensorPriority.as.
 */
...
[ExcludeClass]
public class _Super_SensorPriority extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void 
    {
        try 
        {
            if (flash.net.getClassByAlias("cn.edu.whu.lmars.model.SensorPriority") == null)
            {
                flash.net.registerClassAlias("cn.edu.whu.lmars.model.SensorPriority", cz);
            } 
        }
        catch (e:Error) 
        {
	...
	model_internal var _dminternal_model : _SensorPriorityEntityMetadata;
	...
	public function _Super_SensorPriority() 
	{	
		_model = new _SensorPriorityEntityMetadata(this);
   ...
   model_internal function setterListenerAnyConstraint(value:flash.events.Event):void
   {
    ...
    [Transient] 
	[Bindable(event="propertyChange")] 
    public function get _model() : _SensorPriorityEntityMetadata
    {
		return model_internal::_dminternal_model;              
    }	
    
    public function set _model(value : _SensorPriorityEntityMetadata) : void       
    {
    	var oldValue : _SensorPriorityEntityMetadata = model_internal::_dminternal_model;               
        if (oldValue !== value)
        {
