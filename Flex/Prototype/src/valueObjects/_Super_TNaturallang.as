 ...
 * of this value object you may modify the generated sub-class of this class - TNaturallang.as.
 */
...
[ExcludeClass]
public class _Super_TNaturallang extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void 
    {
        try 
        {
            if (flash.net.getClassByAlias("cn.edu.whu.lmars.model.TNaturallang") == null)
            {
                flash.net.registerClassAlias("cn.edu.whu.lmars.model.TNaturallang", cz);
            } 
        }
        catch (e:Error) 
        {
	...
	model_internal var _dminternal_model : _TNaturallangEntityMetadata;
	...
	private var _internal_flag : int;
	...
	public function _Super_TNaturallang() 
	{	
		_model = new _TNaturallangEntityMetadata(this);
    ...
    {    	
    	...
    	var oldValue:int = _internal_flag;               
        if (oldValue !== value)
        {
   ...
   model_internal function setterListenerAnyConstraint(value:flash.events.Event):void
   {
    ...
    [Transient] 
	[Bindable(event="propertyChange")] 
    public function get _model() : _TNaturallangEntityMetadata
    {
		return model_internal::_dminternal_model;              
    }	
    
    public function set _model(value : _TNaturallangEntityMetadata) : void       
    {
    	var oldValue : _TNaturallangEntityMetadata = model_internal::_dminternal_model;               
        if (oldValue !== value)
        {
